...
8. WHEN a user selects a chart display mode, THE Stock_Chart SHALL show only prices, only EMA lines, or both based on the selection
9. WHEN the chart display mode changes, THE Stock_Chart SHALL update the chart to reflect the new display mode without reloading data
10. WHEN a user selects candlestick chart type, THE Stock_Chart SHALL display price data as candlestick chart with open, high, low, and close values
11. WHEN a user selects line chart type, THE Stock_Chart SHALL display price data as a line chart showing only close prices
12. WHEN the chart type changes, THE Stock_Chart SHALL update the chart to reflect the new chart type without reloading data
